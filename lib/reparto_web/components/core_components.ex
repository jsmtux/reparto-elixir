defmodule RepartoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RepartoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RepartoWeb.Gettext, "errors", msg, opts)
    end
  end
